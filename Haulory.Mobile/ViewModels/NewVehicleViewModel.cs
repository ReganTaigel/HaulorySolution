...
public class NewVehicleViewModel : BaseViewModel, IQueryAttributable
{
    ...
    public int? PowerUnitOdometerKm { get => _state.PowerUnitOdometerKm; set { _state.PowerUnitOdometerKm = value; OnPropertyChanged(); RefreshSaveState(); } }
    public int? Trailer1OdometerKm { get => _state.Trailer1OdometerKm; set { _state.Trailer1OdometerKm = value; OnPropertyChanged(); RefreshSaveState(); } }
    public int? Trailer2OdometerKm { get => _state.Trailer2OdometerKm; set { _state.Trailer2OdometerKm = value; OnPropertyChanged(); RefreshSaveState(); } }
    ...
    public bool ShowOdometers => _validator.ShowOdometers(_state);
    ...
    private void CopyState(NewVehicleFormState loaded)
    {
        ...
        _state.PowerUnitOdometerKm = loaded.PowerUnitOdometerKm;
        _state.Trailer1OdometerKm = loaded.Trailer1OdometerKm;
        _state.Trailer2OdometerKm = loaded.Trailer2OdometerKm;
