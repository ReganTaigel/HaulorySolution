...
public class DeliveryReceipt
{
    ...
    public decimal WaitTimeChargeAmount { get; private set; }

    public bool HandUnloadChargeEnabled { get; private set; }
    public decimal HandUnloadChargeAmount { get; private set; }
        ...
        string? damageNotes = null)
    {
        ...
        WaitTimeChargeAmount = waitTimeChargeAmount;

        HandUnloadChargeEnabled = handUnloadChargeEnabled;
        HandUnloadChargeAmount = handUnloadChargeAmount;
