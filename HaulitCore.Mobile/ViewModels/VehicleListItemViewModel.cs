...
public class VehicleListItemViewModel : INotifyPropertyChanged
{
    ...
    public string HubodometerFullDisplay { get; set; } = "";
    ...
    public static VehicleListItemViewModel FromDto(VehicleDto dto)
    {
        var model = new VehicleListItemViewModel
        {
            ...
            HubodometerFullDisplay = dto.HubodometerKm.HasValue
                ? $"{dto.HubodometerKm.Value:N0} km"
                : "—"
        };
        ...
        if (dto.RucLicenceStartKm != null && dto.RucLicenceEndKm != null)
        {
            ...
            if (dto.HubodometerKm.HasValue)
            {
                var remaining = dto.RucLicenceEndKm.Value - dto.HubodometerKm.Value;
