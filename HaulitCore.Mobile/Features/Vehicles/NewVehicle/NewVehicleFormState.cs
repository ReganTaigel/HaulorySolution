...
public sealed class NewVehicleFormState
{
    ...
    // preserve existing asset ids during edit/update
    ...
    public int? PowerUnitHubodometerKm { get; set; }
    public int? Trailer1HubodometerKm { get; set; }
    public int? Trailer2HubodometerKm { get; set; }
    ...
    public void ResetHubodometers()
    {
        PowerUnitHubodometerKm = null;
        Trailer1HubodometerKm = null;
        Trailer2HubodometerKm = null;
    }
