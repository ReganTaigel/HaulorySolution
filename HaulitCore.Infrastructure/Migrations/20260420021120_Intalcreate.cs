        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RucHubodometerAtPurchaseKm = table.Column<int>(type: "int", nullable: true),
                    ...
                    RucNextDueHubodometerKm = table.Column<int>(type: "int", nullable: true),
                    ...
                    HubodometerKm = table.Column<int>(type: "int", nullable: true),
                    CreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HubodometerReadings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HubodometerReadings_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_HubodometerReadings_UserAccounts_RecordedByUserId",
                        column: x => x.RecordedByUserId,
                        principalTable: "UserAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_HubodometerReadings_VehicleAssets_VehicleAssetId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleAssetId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartHubodometerKm = table.Column<int>(type: "int", nullable: false),
                    EndHubodometerKm = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HubodometerReadings_DriverId",
                table: "HubodometerReadings",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_HubodometerReadings_RecordedByUserId",
                table: "HubodometerReadings",
                column: "RecordedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_HubodometerReadings_VehicleAssetId",
                table: "HubodometerReadings",
                column: "VehicleAssetId");

            migrationBuilder.CreateIndex(
                name: "IX_HubodometerReadings_VehicleAssetId_UnitNumber_RecordedAtUtc",
                table: "HubodometerReadings",
