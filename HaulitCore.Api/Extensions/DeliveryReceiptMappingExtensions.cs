...
public static class DeliveryReceiptMappingExtensions
{
    ...
    public static DeliveryReceiptDto ToDto(this DeliveryReceipt receipt)
    {
        return new DeliveryReceiptDto
        {
            ...
            // Wait time charge configuration and values.
            WaitTimeChargeEnabled = receipt.WaitTimeChargeEnabled,
            WaitTimeChargeAmount = receipt.WaitTimeChargeAmount,

            // Hand unload charge configuration and values.
            HandUnloadChargeEnabled = receipt.HandUnloadChargeEnabled,
            HandUnloadChargeAmount = receipt.HandUnloadChargeAmount,
